...
const ProductDetailsCard = ({
  ...
  const [isSelected, setIsSelected] = useState(data?.sizes?.[0] || '');
    ...
    >
      ...
      >
        <div className="w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w1/2 md:pl-8 mt-6 md:mt-0">
            {/* Seller Info */}
            <div className="border-b relative pb-3 border-gray-200 flex items-center justify-between">
              ...
              <button
                className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition shadow-md font-medium"
