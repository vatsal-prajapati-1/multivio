...
const ProductCard = ({ product, isEvent }: { product: any; isEvent?: any }) => {
  ...
  return (
    <div className="w-full min-h-[350px] h-max bg-white rounded-lg relative">
      ...
      {isEvent && timeLeft && (
        <div className="mt-2">
          <span className="inline-block text-xs bg-orange-100 text-orange-700 font-medium px-2 py-1 rounded-md shadow-md">
            {timeLeft}
          </span>
        </div>
      )}
